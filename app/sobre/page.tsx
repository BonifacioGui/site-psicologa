...
export default function Page() {
  return <main>
    ...
    <section className="content shell study-grid">
      ...
      <div className="study-list" aria-label="Temas de estudo"><span>TCC</span><span>ACT</span><span>DBT</span><span>Mindfulness</span><span>Regulação emocional</span><span>Ansiedade</span><span>Autoestima</span><span>Autocobrança</span><span>Relações interpessoais</span><span>Padrões de pensamento e comportamento</span><span>Avaliação psicológica</span><span>Neuropsicologia</span><span>Cérebro, comportamento e saúde mental</span></div>
    </section>
    <section className="personal-section"><div className="shell personal-grid"><p className="index">Para além da psicóloga</p><div><h2>Também sou alguém que continua se construindo.</h2><p>Fora do consultório, penso, sinto, aprendo e me questiono. Gosto de livros, de momentos tranquilos, de conhecer lugares novos, de estar perto de quem amo e de conversas que vão além do superficial.</p><p>Talvez uma das coisas mais importantes que a minha própria história tenha me ensinado seja esta: eu entendo como pode ser difícil não saber o que fazer com aquilo que você sente.</p><p>Por isso, não acredito em uma Psicologia distante ou em um profissional colocado em um pedestal. Acredito em conhecimento técnico, ética e responsabilidade, mas também em humanidade.</p><div className="actions"><Link className="button" href="/contato">Conversar sobre atendimento</Link><Link className="text-link" href="/formacao">Ver formação e trajetória acadêmica →</Link></div></div></div></section>
  </main>;
}
