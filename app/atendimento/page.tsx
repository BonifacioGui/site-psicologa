...
export default function Page() {
  return <main>
    ...
    <section id="primeira-sessao" className="content narrow shell prose anchor-target"><p className="eyebrow">Primeira sessão</p><h2>Um primeiro encontro para compreender sua trajetória.</h2><p>Na primeira sessão, procuro compreender melhor o que motivou sua busca pela terapia, sua história, suas principais dificuldades e suas expectativas em relação ao acompanhamento.</p><p>Também acolho sua trajetória, esclareço dúvidas e converso com você sobre como será o processo. Você não precisa chegar com tudo organizado ou saber exatamente por onde começar.</p><h2>Depois do primeiro encontro</h2><p>A partir do que conversamos, avaliamos as prioridades iniciais e como o acompanhamento pode contribuir. Revemos os objetivos ao longo do tempo, de acordo com as necessidades percebidas nas sessões.</p></section>
