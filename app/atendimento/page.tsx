...
export default function Page() {
  return <main>
    <PageHero eyebrow="Atendimento" title="Informações claras desde o primeiro contato." intro="Sessões online pelo Google Meet, com duração aproximada de 45 minutos e horários definidos conforme disponibilidade e agendamento prévio." />
    <AnchorNav items={[
    ...
    <section className="content shell session-details">
      <div className="session-summary"><p className="eyebrow">Sobre as sessões</p><h2>45 minutos reservados para o acompanhamento.</h2><p>Os encontros acontecem online pelo Google Meet. Para preservar a privacidade e a qualidade da conversa, é importante estar em um ambiente reservado e utilizar uma conexão estável.</p></div>
      <div className="session-facts"><div><span>Modalidade</span><strong>Online</strong></div><div><span>Plataforma</span><strong>Google Meet</strong></div><div><span>Duração</span><strong>Aproximadamente 45 minutos</strong></div><div><span>Horário</span><strong>Conforme disponibilidade e agendamento prévio</strong></div></div>
    </section>
    ...
    <section id="atendimento-online" className="dark anchor-target"><div className="shell split"><div><p className="eyebrow pale">Atendimento online</p><h2>Privacidade e presença, mesmo à distância.</h2></div><div><p>As sessões são realizadas por videochamada pelo Google Meet. Para aproveitar melhor esse momento, procure um ambiente reservado, use fones de ouvido se isso aumentar sua privacidade e confira a estabilidade da conexão antes do horário combinado.</p><p>O link e as orientações práticas são informados antes do encontro.</p></div></div></section>
